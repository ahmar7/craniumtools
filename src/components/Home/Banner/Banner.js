          ...
          <div className="landing-header">
            <div className="left-colmn">
              ...
              <p className="banner-para">
                Integrate benefits into your project hassle-free. <br /> We
                offer a variety of services for you to choose from!
              </p>

              <button className="building-btn ">Start Building</button>
            </div>
